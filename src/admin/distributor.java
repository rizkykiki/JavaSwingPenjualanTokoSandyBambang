...
// Lalu di tampilkan ke dalam JTable
    ...
    private void initComponents() {
        ...
        tgl.setText("Data Kontak Distributor");
        tgl.setToolTipText("");
        ...
        students.setBackground(new java.awt.Color(255, 0, 0));
        ...
        ido.setBackground(new java.awt.Color(255, 0, 0));
        ...
        jPanel1.add(ops, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 170, 200, 70));
        ...
        jPanel1.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 170, 170, -1));
        ...
        jPanel1.add(jPanel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 240, -1, -1));

        kGradientPanel2.add(jPanel1);
        jPanel1.setBounds(130, 30, 780, 290);
...
this.dispose();    // TODO add your handling code here:
    ...
    private void jPanel13MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel13MousePressed
        ...
        if (tlp == null || "".equals(tlp) || " ".equals(tlp)
            ...
            try {
                stat.executeUpdate("update distributor set "

                    //   + "id_peg='" + idperpus.getText() + "',"
                    + "nama_distributor='" + nama.getText() + "',"
                    + "tlp_distributor='" + tlp.getText()+ "',"
                    + "alamat_distributor='" + alamat.getText() + "'"
                   
                    + " where "
                    + "id_distributor='" + id.getText() + "'"
                );
                // kosongkan();
                tabel();
    ...
    private void jPanel15MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel15MousePressed
        ...
        if(ok==0){
            try {
                stat.executeUpdate("delete from distributor where "
                    + "id_distributor='" + id.getText() + "'"
                );
                 kosongkan();
                tabel();
...
String pola = null;
   ...
   pola = "EEEE+dd+MMMM+yyyy";
                ...
                hasil = distributor.tampilkanTanggalDanWaktu(tanggalDanWaktu,pola,lokal);
                String aa =  hasil ;
                String gg= "http://localhost/tokosb/distributor.php?id="+ido.getText();
        ...
        if(Desktop.isDesktopSupported()){
            try {
               // Desktop.getDesktop().browse(new URI("http://localhost/tokosb/distributor.php?id="+ido.getText()));
