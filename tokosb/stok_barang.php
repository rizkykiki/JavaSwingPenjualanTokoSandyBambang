...
<tr>
	...
	<hr>
	<p class="judul">LAPORAN DATA STOK BARANG</p>
	<table border="1" align="center">
       ...
       // $id = mysql_real_escape_string();
				$sql = "SELECT * FROM stok_barang where nama_barang like '%".$_GET['id']."%' or id_barang like '%".$_GET['id']."%' or jenis_barang like '%".$_GET['id']."%' or tipe_barang like '%".$_GET['id']."%'";
