...
<hr>
	...
	<table border="1">
			...
			<tr>
				...
				<td align="right"><?php echo $data['cash'] ?></td>
				<td align="right"><?php echo $data['kembalian'] ?></td>
				<td><a href="struk.php?id=<?php echo $data['id_trans'] ?>">Cetak Struk</a></td>
			</tr>
			<?php }?>
		</table>
		<br>
		<p class="abc"><a href="datatransaksi2.php">CETAK LAPORAN</a></p>
</body>
</html>