...
<tr>
	...
	<hr>
	<p class="judul">LAPORAN DATA DSTRIBUTOR</p>
	<table border="1" align="center">
       ...
       // $id = mysql_real_escape_string();
				$sql = "SELECT * FROM distributor where id_distributor like '%".$_GET['id']."%' or nama_distributor like '%".$_GET['id']."%' or alamat_distributor like '%".$_GET['id']."%'";
			...
			<td><?php echo $data['id_distributor'] ?></td>
				...
				<td><?php echo $data['tlp_distributor'] ?></td>
